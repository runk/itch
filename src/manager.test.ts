...
import { MessageAddOrder, MessageOrderDelete } from './parser/msg';
...
describe('message types', () => {
  ...
  it('supports AddOrder message', () => {
    const order = manager(new MessageAddOrder(Buffer.from('41000d00001790c194795e00000000002b8ef942000000644141504c202020200030fa48', 'hex')));
  ...
  it.skip('supports OrderDelete message', () => {
    const order = manager(new MessageOrderDelete(Buffer.from('44000d00001c0f75504eb2000000000059170d', 'hex')));
    expect(order).toEqual({
      stock: 'AAPL    ',
      locate: 13,
      price: 3209800,
